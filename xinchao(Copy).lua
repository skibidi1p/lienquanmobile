shared.LoaderTitle = "Liên Quân Mobile";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://120563553290983",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=120563553290983";
v24.Parent = v23;
